class CreateCountries < ActiveRecord::Migration
  def self.up
    ...
    # Change Bar column to id
    remove_column :bars, :country
    add_column :bars, :country_id, :integer
    add_index :bars, :country_id 
    ...
    # Set all bars to Germany
    Bar.all.each{ |b| b.update_attribute(:country_id, Country.find_by_iso("DE").id) }
  end
  ...
  def self.down
    ...
    # Change Bar column to id
    remove_column :bars, :country_id
    add_column :bars, :country, :string
    Bar.all.each{ |b| b.update_attribute(:country, "Germany") }
  end
end
