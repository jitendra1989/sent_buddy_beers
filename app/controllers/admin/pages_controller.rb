class Admin::PagesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @page.save
        format.html { redirect_to(admin_page_url(@page.slug), :notice => 'Page was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @page.update_attributes(params[:page])
        format.html { redirect_to(admin_page_url(@page.slug), :notice => 'Page was successfully updated.') }
        format.xml  { head :ok }
      else
